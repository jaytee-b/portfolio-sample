      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:blue-500-30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
            <h3 className="text-xl font-bold mb-2">Videography Portfolio</h3>
            <p className="text-gray-400 mb-4">
              Visually appealing and user-friendly platform that effectively
              showcases my client&apos;s work and enhances their online
              presence.
            </p>
            <div className="flex flex-wrap gap-2 mb-4">
              {applicationsUsed.map((tech, key) => (
                <span
                  key={key}
